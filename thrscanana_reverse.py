...
if __name__=="__main__":
    ...
    parser.add_argument('--reverse','-r',action='store_true',help="Thrscanan for reverse scan")
    parser.add_argument('--notext','-n',action='store_true',help="Remove warning for hit from bad row")
